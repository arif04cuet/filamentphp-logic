        ...
        <div class="h-12 flex items-center space-x-4 rtl:space-x-reverse">
            ...
            <div>
                ...
                <form action="{{ route('filament.auth.logout') }}" method="post" class="text-sm">
                    ...
                    <button type="submit" @class([ 'text-gray-600 hover:text-primary-500 outline-none focus:underline' , 'dark:text-gray-300 dark:hover:text-primary-500'=> config('filament.dark_mode'),
                        ])
                        >
